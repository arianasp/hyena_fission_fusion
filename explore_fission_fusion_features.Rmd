...
chordDiagram(t(trans.travel),
             grid.col = rep(fusion.cols, 2), annotationTrack = 'grid', preAllocateTracks = list(list(list(track.height = 0.3, list(track.height = 0.9)))))
...
## Event type examples
>>>>>>> 20297f410fb90a97c62d9f772d08333bc696a361
